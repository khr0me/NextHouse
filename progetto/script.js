...
const SmartHome = {
  ...
  startDataSimulation: function () {
    ...
    function simulateChanges() {
      ...
      const currentTemp = parseFloat(
        self.elements.temperatureDisplay.textContent
      );
  ...
  // gestione della aggiunta di un nuovo dispositivo tramie un modal
  ...
  addDeviceToUI: function (deviceName, deviceType, deviceRoom) {
    // ottiene nome della stanza per la visualizzazione
